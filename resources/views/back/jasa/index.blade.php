      ...
      <form action="{{ route('jasa.store') }}" method="post" id="tambahJasaForm" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" name="jasa_whatsapp_message" placeholder="Pesan WhatsApp"
              style="height: 100%;"></textarea>
          </div>
          <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <form action="{{ route('jasa.update', $jasa->id) }}" method="post" id="editJasaForm"
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="message">Pesan WhatsApp</label>
            <textarea class="form-control" name="edit_jasa_whatsapp_message" placeholder="Pesan WhatsApp"
              style="height: 100%;">{{ $jasa->whatsapp_message }}</textarea>
          </div>
          <div class="form-group">
            <label for="image">Gambar</label>
            <input type="file" class="form-control dropify" name="edit_jasa_image"
              data-allowed-file-extensions="png jpg jpeg svg" data-default-file="@if(!empty($jasa->image) &&
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="d-flex justify-content-between">
              <i class="fab fa-whatsapp mt-1" style="font-size: 20px;"></i>
              <p class="ml-3">{{ $jasa->whatsapp_message }}</p>
          </div>
      </div>
      <div class="modal-footer bg-whitesmoke br">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Kembali</button>
...
<script>
  ...
  $("#tambahJasaForm").validate({
      ...
      messages: {
          ...
          jasa_whatsapp_message: {
                  required: "Pesan WhatsApp harus di isi",
          },
          jasa_image: {
