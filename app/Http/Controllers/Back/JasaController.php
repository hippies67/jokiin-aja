...
class JasaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data = [
            ...
            'whatsapp_message' => $request->jasa_whatsapp_message,
            'image' => $image
        ];
    ...
    public function update(Request $request, $id)
    {
        ...
        $data = [
            ...
            'whatsapp_message' => $request->edit_jasa_whatsapp_message ? $request->edit_jasa_whatsapp_message : $jasa->whatsapp_message,
